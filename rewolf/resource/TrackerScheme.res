...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"150 215 210 255"	// used in text windows, lists
		"BrightBaseText"	"190 250 255 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"160 160 165 255"	// dim base text
		"LabelDimText"		"160 160 165 255"	// used for info text
		"ControlText"		"120 125 130 255"	// used in all text controls
		"BrightControlText"	"150 160 165 255"	// use for selected controls
		"DisabledText1"		"115 128 110 255"	// disabled text
		"DisabledText2"		"40 45 50 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"110 130 130 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"30 55 60 255"		// background color of controls
		"ControlDarkBG"		"15 35 40 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"0 0 0 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"80 80 100 255"	// background color of any selected text or menu item
		"SelectionBG2"		"50 50 60 255"		// selection background in window w/o focus
		"ListBG"			"20 40 45 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 255 255 255"
		"TitleDimText"		"128 128 128 255"
		"TitleBG"			"30 55 60 255"
		"TitleDimBG"		"30 55 60 255"
		
		// slider tick colors
		"SliderTickColor"	"125 140 125 255"
		"SliderTrackColor"	"30 30 30 255"

		// border colors
		"BorderBright"		"115 165 170 255"	// the lit side of a control
		"BorderDark"		"60 90 140 255"		// the dark/unlit side of a control
		"BorderSelection"	"190 250 255 255"			// the additional border color for displaying the default/selected button
	}
...
//		"ButtonDepressedBgColor"
		...
		InGameDesktop
		{
			"MenuColor"			"15 235 235 255"
			"ArmedMenuColor"	"190 250 255 255"
